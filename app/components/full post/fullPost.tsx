...
export const FullPost = () => {
    return (
        ...
        <div className="bg-slate-50 overflow-y-auto md:w-[700px] w-full md:h-[90vh] p-4 md:rounded-[10px]  ">
          ...
          <div className=" p-2 gap-[20px]  flex-col flex">
            ...
            <div className="flex items-center border-t border-b bg-slate-50 py-[10px] justify-around">
              ...
              <div className=" flex items-center p-[5px] gap-x-[5px] rounded"><BiRepost className="text-[20px] " /><p className="text-slate-500">10 Repost</p></div>
                        ...
                        {/* COMMENTS UNDER POST */}
                        <div className="flex flex-col bg-slate-100 rounded-xl p-2">
                        <div className="flex gap-1 flex-row items-center">
              <h1 className="font-bold flex items-center ">  <FaUserCircle className="text-[30px] bg-slate-50 rounded-full shadow-2xl " />@Nzubechukwu</h1> <span className="text-slate-500 text-[10px] ">Commented</span> <GoDotFill/> <p className="text-slate-500 text-[10px]">2nd March 2024</p>
            </div>
