...
//   const publishPostFn = async () => {
//     if (!loggedInUser) {
//       toast.info("Kindly login before you make any post", {
//         hideProgressBar: true
//       })
//       return;
//     }
//     if (thePost.postContent === '') {
//       toast.info("Please input post content", {
//         hideProgressBar: true
//       })
//       return;
//     }
...
//         })
//       } catch (error) {
//         toast.error("Try adding Image Again", {
//           hideProgressBar: true
//         })
//       }
//     }
...
//           </div>
//         </form>
//         <button onClick={publishPostFn} type="button" className="bg-slate-900  py-[15px]  w-[50%] text-[20px] text-slate-50 rounded ">Publish</button>
//       </div>
//     </div>)
//   }